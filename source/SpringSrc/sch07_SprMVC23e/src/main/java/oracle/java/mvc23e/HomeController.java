...
public class HomeController {
	...
	public String buy_ticket_card(TicketDto ticketDto, Model model) {
		System.out.println("buy_ticket_card()  start...");
		System.out.println("ticketDto : getConsumerId -> " + ticketDto.getConsumerId());
		System.out.println("ticketDto : getAmount -> " + ticketDto.getAmount());		
