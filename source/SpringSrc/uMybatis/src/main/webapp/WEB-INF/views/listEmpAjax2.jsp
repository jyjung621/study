...
<body>
	...
	<p>
		...
		RestController Java Script: sendVO2<input type="button"
			id="btn_script" value="Java Script" onclick="getTest()">
	<p>

		<input class="btn btn-primary btn-xs" type="button" value="교번확인" onclick="teacherCheck();" />
	<p>
